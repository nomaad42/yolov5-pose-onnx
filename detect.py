...
def detect(opt):
    source, weights, view_img, save_txt, imgsz, save_txt_tidl, kpt_label = opt.source,\
        opt.weights, opt.view_img, opt.save_txt, opt.img_size, opt.save_txt_tidl, opt.kpt_label
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        print("\nAFTER NMS (pred[0].shape): ", pred[0].shape)
