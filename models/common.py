...
from utils.general import non_max_suppression, non_max_suppression_export, make_divisible, scale_coords, increment_path, \
    ...
    def __init__(self, c1, c2, k=(3, 3, 3)):
        ...
        for pool_kernel in k:
            ...
            max_pool_module_list.append(
                nn.Sequential(*num_3x3_maxpool * [nn.MaxPool2d(kernel_size=3, stride=1, padding=1)]))
